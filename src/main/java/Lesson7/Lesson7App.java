...
public class Lesson7App {
    ...
    // sometimes func accept parameters. In this func it returns
    // an array
    ...
    public static String[] twoFristElements(String[] fruits){
