...
public class Apphw16hh {
    public static void main(String[] args) {
        ...
        try {
            ...
            Doctor chai = new Doctor("Edward", "Chai", Title.NEUROLOGIST);Doctor burger = new Doctor("Steven", "Burger", Title.SURGEON);
            ...
            System.out.println("**********************************************");
            System.out.println("Yay! There are no errors in my code. :)");
        }
    }
}
