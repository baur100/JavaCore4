...
//        Thread.sleep(5000);
       ...
       */
       ...
       /*This is what happens under the wait codes*/
       while(xx /*&& maxTime<20*/){
           try{
...
//        WebElement emailField = driver.findElement(By.cssSelector("[type='email']"));
        WebElement pwdField = driver.findElement(By.xpath("//*[@type='password']"));
        WebElement loginButton = driver.findElement(By.cssSelector("[type='submit']"));

//        emailField.sendKeys("testpro.user04@testpro.io");
        emailField.sendKeys("busyteddy@gmail.com");
        pwdField.sendKeys("te$t$tudent");
        loginButton.click();
//        Thread.sleep(2000);
        webDriverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("playerControls")));
